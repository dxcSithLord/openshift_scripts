#!/usr/bin/env python3
'''
With reference to how to perform the conversion, see :
https://developers.redhat.com/learning/learn:openshift:replace-deprecated-deploymentconfigs-deployments/resource/resources:convert-deploymentconfig-deployment
With reference to the original version of this, see:
https://gist.github.com/bomboclat/1c53b7e692b1df58af67598337cc2b88
